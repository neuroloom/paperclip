CREATE TABLE plugin_missions_8ceb7cd69c.missions (
...
CREATE TABLE plugin_missions_8ceb7cd69c.mission_findings (
  mission_issue_id uuid NOT NULL REFERENCES plugin_missions_8ceb7cd69c.missions(mission_issue_id) ON DELETE CASCADE,
...
CREATE TABLE plugin_missions_8ceb7cd69c.mission_events (
  mission_issue_id uuid NOT NULL REFERENCES plugin_missions_8ceb7cd69c.missions(mission_issue_id) ON DELETE CASCADE,
  company_id uuid NOT NULL,
